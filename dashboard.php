...
$productSql = "SELECT * FROM reviews";
...
if (mysqli_num_rows($productResult) > 0) {
    ...
    while ($row = mysqli_fetch_assoc($productResult)) {
        ...
        $reviewsSql = "SELECT reviews.*, user_new.first_name FROM reviews JOIN user_new ON reviews.user_name = user_new.first_name WHERE reviews.review_type_id = " . $row['product_id'];
        ...
        if (mysqli_num_rows($reviewsResult) > 0) {
            ...
            $reviewCountSql = "SELECT COUNT(*) AS review_count FROM reviews WHERE review_type_id = " . $row['product_id'];
            ...
            $averageRatingSql = "SELECT AVG(rating) AS average_rating FROM reviews WHERE review_type_id = " . $row['product_id'];
